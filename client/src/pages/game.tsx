...
export default function Game() {
  ...
  const { connected } = useWebSocket(`/ws`, {
    onMessage: (message) => {
      if (message.type === "game_state" || message.type === "card_played" || message.type === "accusation") {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2 text-sm">
                ...
                <span className="font-mono">0:{Math.floor(game.turnTimer)}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <Dialog open={showRevelation} onOpenChange={() => {}}>
